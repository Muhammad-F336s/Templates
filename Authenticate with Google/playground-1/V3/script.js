...
passwordToggleButtons.forEach(button => {
  button.addEventListener('click', () => {
    ...
    const eyePath = button.querySelector('.eye-icon path');
...
signinForm.addEventListener('submit', (e) => {
  ...
  console.log('Organic Portal Sign In:', { email, password });
...
signupForm.addEventListener('submit', (e) => {
  ...
  console.log('Organic Portal Sign Up:', { name, email, password });
